...
@section('page_title', 'Add Finance Bank')

@section('add_finance_page_active','active open')
@section('content')
            ...
            <div class="col-md-7 mx-auto">
                <div class="card mb-4">
                    <div class="card-header d-flex justify-content-between align-items-center">
                        ...
                        <h5 class="mb-0">Add Finance Bank</h5>

                    </div>
                    <div class="card-body">
                        <form action="{{route('admin.insert/finance_banks')}}" method="POST" enctype="multipart/form-data">
                            @csrf
