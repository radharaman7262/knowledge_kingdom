...
@section('page_title',' Add Countries')
@section('add_countries_active','active open')
@section('content')
    <!-- Content wrapper -->
            ...
            <div class="row">
                <div class="col-md-7 mx-auto">
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.insert.countries') }}" method="POST"
                                ...
                                <div class="mb-3">
                                 ...
                                 <textarea name="universities" class="form-control" id="universities" >{{ old('universities') }}</textarea>
                                ...
                                <div class="mb-3">
                                 ...
                                 <textarea name="hightlights" class="form-control" id="hightlights" >{{ old('hightlights') }}</textarea>
